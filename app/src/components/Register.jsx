...
const Register = () => {
  ...
  return (
    <div className="relative min-h-screen py-10 px-4 sm:px-6 lg:px-8 flex items-center">
      ...
      <div className="absolute inset-0 -z-10 bg-white/75"></div>

      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-10 items-center mx-auto">
        <div>
        ...
        <form className="mt-8 space-y-6 bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sm:p-8 lg:p-10" onSubmit={handleSubmit}>
          {errors.general && (
